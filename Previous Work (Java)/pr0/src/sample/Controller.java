...
public class Controller implements Initializable{
	...
	public void handleButtonAction(ActionEvent event){
		if (event.getSource() == receipt_button) {
			...
			chooseproduct_name_modify.getItems().add(productOptions);
...
//defining the axes
		...
		productsData.addAll(new Product("Washing Powder 20kg",50,"Washing Powder"),
				new Product("Washing Powder 10kg",30,"Washing Powder"),
				new Product("Washing Up liquid",5,"Washing Up Liquid"),
				new Product("Washing Liquid",10,"Washing Liquid"),
				new Product("Shampoo 0,5 lt",4,"Shampoo"),
				new Product("Shampoo 1lt",6,"Shampoo"));

		productTable.setItems(productsData);
		productTable1.setItems(productsData);

		clientsData.addAll(new Customer(clientId++,"Foivos","Panagi","email","phone","address",0.0),
				new Customer(clientId++,"Chrisis","Panagi","email","phone","address",0.0),
				new Customer(clientId++,"Christopher","Panagi","email","phone","address",0.0),
				new Customer(clientId++,"Savvas","Panagi","email","phone","address",0.0),
				new Customer(clientId++,"Panikos","Panagi","email","phone","address",0.0));
