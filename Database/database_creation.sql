...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `invoice`.`viewInvoice` (`InvoiceID` INT, `CustomerName` INT, `InvoiceCost` INT, `VAT` INT, `InvoiceTotalCost` INT, `Date` INT, `ProductName` INT, `Quantity` INT, `IPCost` INT);
