...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `invoice`.`viewReceipt` (`ReceiptID` INT, `TotalAmount` INT, `IssuedDate` INT, `IssuedBy` INT, `idCustomer` INT, `CustomerName` INT, `PhoneNumber` INT, `Email` INT, `Country` INT, `City` INT, `Address` INT, `Balance` INT, `idPayment` INT, `idReceipt` INT, `PaymentMethod` INT, `Amount` INT, `PaymentNumber` INT, `PaymentDate` INT);
