...
namespace InvoiceX.Forms
{
    ...
    public class QuoteForm
    {
        ...
        {
            this.quote = new XmlDocument();
            this.quote.Load(filename);
            this.navigator = this.quote.CreateNavigator();
            this.customer_details = cd;
            this.quote_details = id;
            this.products = p;
        }
        ...
        public Document CreateDocument()
        {
            ...
            this.document.Info.Title = "Quote";
        ...
        void CreatePage()
        {
            ...
            this.quoteDetailsFrame = section.AddTextFrame();
            this.quoteDetailsFrame.Height = "3.0cm";
            this.quoteDetailsFrame.Width = "7.0cm";
            this.quoteDetailsFrame.Left = ShapePosition.Right;
            this.quoteDetailsFrame.RelativeHorizontal = RelativeHorizontal.Margin;
            this.quoteDetailsFrame.Top = "3cm";
            this.quoteDetailsFrame.RelativeVertical = RelativeVertical.Page;
            ...
            Column column = this.table2.AddColumn("6cm");
            column.Format.Alignment = ParagraphAlignment.Center;

            column = this.table2.AddColumn("6cm");
            column.Format.Alignment = ParagraphAlignment.Right;

            column = this.table2.AddColumn("4cm");
            column.Format.Alignment = ParagraphAlignment.Right;
            ...
            row.Cells[0].AddParagraph("Salesperson");
            row.Cells[0].Format.Font.Bold = true;
            row.Format.LineSpacing = 10;
            row.Cells[0].Format.Alignment = ParagraphAlignment.Center;
            row.Cells[0].VerticalAlignment = VerticalAlignment.Bottom;
            row.Cells[1].AddParagraph("Contact Info");
        ...
        void FillContent()
        {
            ...
            paragraph = this.quoteDetailsFrame.AddParagraph();
            paragraph.Format.Alignment = ParagraphAlignment.Center;
            ...
            paragraph.AddText("QUOTE #");
            paragraph.AddSpace(16);
            paragraph.AddText("DATE");
            
            paragraph = this.quoteDetailsFrame.AddParagraph();
            paragraph.Format.Alignment = ParagraphAlignment.Right;
            String quoteNumber = this.quote_details[0];
            String date = this.quote_details[1];
